...
export default function PurchaseOrdersScreen() {
  const styles = useThemedStyles(c => ({
    ...
    errorBox: { margin: 16, backgroundColor: c.dangerBg, borderRadius: 12, padding: 16, alignItems: 'center' },
    errorText: { color: c.danger, textAlign: 'center' },
    retry: { color: c.accent, fontWeight: '700', marginTop: 8 },
    card: {
    ...
    number: { fontSize: 14.5, fontWeight: '800', color: c.text, fontFamily: 'monospace' },
    badge: { borderRadius: 8, paddingHorizontal: 9, paddingVertical: 4 },
    badgeText: { fontSize: 11, fontWeight: '800' },
    supplier: { fontSize: 13.5, fontWeight: '700', color: c.text, marginTop: 8 },
    meta: { fontSize: 12.5, color: c.muted, marginTop: 3 },
    metaLight: { fontSize: 11, color: c.muted, marginTop: 3, opacity: 0.8 },
    expandHint: { position: 'absolute', right: 2, bottom: 4, color: c.muted, fontSize: 10 },
    itemsBox: {
      marginTop: 12,
      borderTopWidth: 1,
    ...
    itemName: { flex: 1, fontSize: 12.5, color: c.text, fontWeight: '600' },
    itemQty: { fontSize: 12.5, color: c.muted, marginHorizontal: 10, fontWeight: '700' },
    editHint: { fontSize: 11.5, color: c.info, marginBottom: 8 },
    ...
    stepText: { fontSize: 14, color: c.text, fontWeight: '800' },
    stepQty: { width: 30, textAlign: 'center', fontSize: 13.5, fontWeight: '800', color: c.text },
    itemSub: { fontSize: 12.5, color: c.accent, fontWeight: '800' },
    ...
    sheetHint: { fontSize: 12, color: c.muted, marginTop: 4, marginBottom: 12 },
    rcvRow: {
      flexDirection: 'row',
      alignItems: 'center',
      paddingVertical: 9,
    ...
    rcvProgress: { fontSize: 11, color: c.muted, marginTop: 2 },
    ...
    allBtnText: { color: c.info, fontSize: 12, fontWeight: '800' },
    closeSheet: { alignItems: 'center', marginTop: 12, paddingVertical: 6 },
    closeSheetText: { color: c.muted, fontSize: 13, fontWeight: '700' },
    fCard: { backgroundColor: c.card, borderRadius: 14, padding: 14, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: c.primary },
    fTitle: { color: c.text, fontWeight: '800', fontSize: 14, marginBottom: 2 },
    fHint: { color: c.muted, fontSize: 11.5, marginBottom: 8 },
    fRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
    fSupplier: { color: c.text, fontWeight: '700', fontSize: 13 },
    fLine: { color: c.muted, fontSize: 11.5, marginTop: 2 },
    fQty: { color: c.primary, fontWeight: '900', fontSize: 12, marginLeft: 8 },
  }));
  const { t } = useLocale();
