...
import { listQuotes, removeQuote, saveQuote, buildQuoteText } from '../utils/quotes';
import { effectivePrice, promoActive } from '../utils/promo';
...
export default function NewSaleScreen({ navigation }) {
  const styles = useThemedStyles(c => ({
    ...
    pointsLabel: { color: c.text, fontSize: 13, fontWeight: '700' },
    pointsHint: { color: c.muted, fontSize: 11.5, marginTop: 2 },
    search: {
    ...
    resultMeta: { fontSize: 12, color: c.muted, marginTop: 2 },
    resultThumb: { width: 34, height: 34, borderRadius: 8, marginRight: 10, backgroundColor: c.cardAlt },
    thumbPh: { alignItems: 'center', justifyContent: 'center' },
    tvaLabel: { fontSize: 12, color: c.muted },
    tvaValue: { fontSize: 12, fontWeight: '700', color: c.muted },
    addBtn: { fontSize: 22, color: c.primary, fontWeight: '800', paddingHorizontal: 8 },
    sectionTitle: { fontSize: 15, fontWeight: '800', color: c.text, marginTop: 20, marginBottom: 10 },
    emptyCart: {
      backgroundColor: c.card,
      borderRadius: 14,
      padding: 30,
    ...
    emptyTitle: { fontSize: 15, fontWeight: '800', color: c.text, marginTop: 8 },
    emptySub: { fontSize: 12.5, color: c.muted, marginTop: 3 },
    card: {
      backgroundColor: c.card,
      borderRadius: 14,
      padding: 14,
    ...
    cartName: { fontSize: 14, fontWeight: '700', color: c.text },
    cartSub: { fontSize: 12, color: c.muted, marginTop: 2 },
    cartThumb: { width: 30, height: 30, borderRadius: 7, marginRight: 9, backgroundColor: c.cardAlt },
    cartHeadRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    quoteBtn: { backgroundColor: c.cardAlt, borderRadius: 9, paddingHorizontal: 10, paddingVertical: 6, borderWidth: 1, borderColor: c.border },
    quoteBtnText: { fontSize: 12.5, fontWeight: '700', color: c.text },
    quoteOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'flex-end' },
    quoteCard: { backgroundColor: c.card, borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: 16, maxHeight: '82%' },
    quoteHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
    quoteTitle: { fontSize: 15, fontWeight: '800', color: c.text },
    quoteSave: { backgroundColor: c.primary, borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
    quoteSaveText: { fontSize: 13, fontWeight: '800', color: '#fff' },
    quoteSection: { fontSize: 12, fontWeight: '700', color: c.muted, marginTop: 12, marginBottom: 6, textTransform: 'uppercase' },
    quoteNone: { fontSize: 12.5, color: c.muted, textAlign: 'center', paddingVertical: 18 },
    quoteRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 9, borderBottomWidth: 1, borderBottomColor: c.border, gap: 6 },
    quoteId: { fontSize: 13, fontWeight: '700', color: c.text },
    quoteMeta: { fontSize: 11, color: c.muted, marginTop: 1 },
    quoteTotal: { fontSize: 13, fontWeight: '800', color: c.accent, marginRight: 2 },
    ...
    stepText: { fontSize: 16, color: c.text, fontWeight: '800' },
    stepQty: { width: 32, textAlign: 'center', fontSize: 15, fontWeight: '800', color: c.text },
    payTabs: {
      flexDirection: 'row',
      backgroundColor: c.card,
      borderRadius: 12,
    ...
    payTabActive: { backgroundColor: c.primaryBg },
    payTabCreditActive: { backgroundColor: c.warningBg },
    payTabText: { fontSize: 13, fontWeight: '800', color: c.muted },
    payTabTextActive: { color: c.primary },
    restRow: {
      flexDirection: 'row',
    ...
    restLabel: { fontSize: 13, fontWeight: '700', color: c.muted },
    ...
    linkCustomerText: { color: c.primary, fontWeight: '800', fontSize: 13.5 },
    customerChip: {
      flexDirection: 'row',
      alignItems: 'center',
      backgroundColor: c.card,
    ...
    customerChipName: { fontSize: 14, fontWeight: '800', color: c.text },
    customerChipPhone: { fontSize: 11.5, color: c.muted, marginTop: 1 },
    customerChipRemove: { fontSize: 15, color: c.muted, fontWeight: '800', paddingHorizontal: 6 },
    totalRow: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      alignItems: 'center',
