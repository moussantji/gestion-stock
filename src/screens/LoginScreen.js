...
export default function LoginScreen() {
  ...
  const styles = useThemedStyles(c => ({
    ...
    errorBox: { backgroundColor: c.dangerBg, borderRadius: 10, padding: 12, marginBottom: 14 },
    errorText: { color: c.danger, fontSize: 13, textAlign: 'center' },
    demo: { marginTop: 18, borderTopWidth: 1, borderTopColor: c.border, paddingTop: 12 },
    googleBtn: {
    ...
    googleBtnText: { color: c.text, fontWeight: '800', fontSize: 14 },
    codeBox: {
      marginTop: 12, borderRadius: 12, padding: 12,
      borderWidth: 1, borderColor: c.border, backgroundColor: c.cardAlt,
    },
    codeHint: { fontSize: 12, color: c.muted, marginBottom: 10, textAlign: 'center', lineHeight: 17 },
    demoTitle: { fontSize: 12, fontWeight: '700', color: c.muted, textTransform: 'uppercase', marginBottom: 4, textAlign: 'center' },
    demoText: { fontSize: 12, color: c.muted, textAlign: 'center' },
  }));
