...
export default function ShopSettingsScreen() {
  ...
  const styles = useThemedStyles(c => ({
    ...
    intro: { color: c.muted, fontSize: 12.5, marginBottom: 14, lineHeight: 18 },
    card: {
    ...
    hint: { color: c.muted, fontSize: 12, marginTop: 4, lineHeight: 16.5 },
    range: { color: c.muted, fontSize: 10.5, marginTop: 4, fontWeight: '600' },
    input: {
