...
export default function InventoryCountScreen({ route, navigation }) {
  ...
  const styles = useThemedStyles(c => ({
    ...
    refText: { fontSize: 12.5, fontWeight: '800', color: c.accent, fontFamily: 'monospace' },
    progressText: { fontSize: 13, fontWeight: '700', color: c.text, marginTop: 4 },
    barTrack: {
      height: 6,
      borderRadius: 3,
    ...
    pendingText: { fontSize: 13, color: c.muted, fontWeight: '700', marginLeft: 8 },
    diffChip: { borderRadius: 9, paddingHorizontal: 8, paddingVertical: 3, marginLeft: 8 },
    diffZero: { backgroundColor: c.border },
    diffPlus: { backgroundColor: c.infoBg },
    diffMinus: { backgroundColor: c.dangerBg },
    ...
    stepQty: { width: 34, textAlign: 'center', fontSize: 15, fontWeight: '800', color: c.text },
    countedStatic: { fontSize: 15, fontWeight: '900', color: c.text, marginLeft: 10 },
  }));
