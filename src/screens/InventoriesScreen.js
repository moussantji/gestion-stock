...
export default function InventoriesScreen({ navigation }) {
  ...
  const styles = useThemedStyles(c => ({
    ...
    statusOpen: { backgroundColor: c.warningBg },
    statusDone: { backgroundColor: c.successBg },
    statusText: { fontSize: 10.5, fontWeight: '800' },
    progress: { fontSize: 10.5, color: c.muted, fontWeight: '700' },
    fab: {
      position: 'absolute',
      right: 20,
      bottom: 30,
    ...
    sheetHint: { fontSize: 11.5, color: c.muted, marginTop: 2, marginBottom: 4 },
    submit: {
      backgroundColor: c.primary,
      borderRadius: 14,
      paddingVertical: 15,
    ...
    cycleCard: { backgroundColor: c.card, borderRadius: 14, padding: 14, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: c.accent },
    cycleTitle: { color: c.text, fontWeight: '800', fontSize: 14, marginBottom: 4 },
    cycleHint: { color: c.muted, fontSize: 12, marginBottom: 8 },
    cycleRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 10 },
    cycleChip: { backgroundColor: c.bg, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, maxWidth: '48%' },
    cycleChipText: { color: c.text, fontSize: 11 },
  }));
