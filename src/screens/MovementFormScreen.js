...
export default function MovementFormScreen({ route, navigation }) {
  const styles = useThemedStyles(c => ({
    ...
    productMeta: { fontSize: 13, color: c.muted, marginTop: 3 },
    ...
    offlineText: { color: c.warning, fontSize: 12.5, fontWeight: '600' },
    ...
    typeText: { fontSize: 15, fontWeight: '800', color: c.muted },
    ...
    reasonText: { fontSize: 13, fontWeight: '600', color: c.muted },
