...
export default function ProductFormScreen({ route, navigation }) {
  const styles = useThemedStyles(c => ({
    ...
    photoHint: { color: c.text, fontWeight: '700', marginTop: 8, fontSize: 14 },
    photoSub: { color: c.muted, fontSize: 11.5, marginTop: 2 },
    photoEdit: {
      position: 'absolute',
      bottom: 10,
      right: 10,
    ...
    selectPlaceholder: { fontSize: 15, color: c.muted },
    ...
    hint: { fontSize: 12, color: c.muted, marginBottom: 12, marginTop: -4 },
