...
export default function PrinterSettingsScreen() {
  const styles = useThemedStyles(c => ({
    ...
    warningTitle: { color: c.warning, fontWeight: '800', fontSize: 13.5 },
    warningText: { color: c.warning, fontSize: 12, marginTop: 3, opacity: 0.9 },
    card: {
    ...
    savedName: { fontSize: 15, fontWeight: '800', color: c.text },
    savedMac: { fontSize: 11.5, color: c.muted, fontFamily: 'monospace', marginTop: 2 },
    disconnectBtn: {
      borderRadius: 9,
    ...
    disconnectText: { color: c.danger, fontWeight: '700', fontSize: 12 },
    ...
    pickHint: { fontSize: 12.5, color: c.muted, marginBottom: 8, paddingHorizontal: 4 },
    deviceRow: {
      flexDirection: 'row',
      alignItems: 'center',
      paddingVertical: 11,
    ...
    deviceRowActive: { backgroundColor: c.primaryBg },
    deviceName: { fontSize: 13.5, fontWeight: '700', color: c.text },
    deviceMac: { fontSize: 11, color: c.muted, fontFamily: 'monospace', marginTop: 1 },
  }));
  const { t } = useLocale();
