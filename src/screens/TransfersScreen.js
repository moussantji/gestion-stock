...
export default function TransfersScreen() {
  ...
  const styles = useThemedStyles(c => ({
    ...
    reference: { fontSize: 14, fontWeight: '800', color: c.text, fontFamily: 'monospace' },
    linesCount: { fontSize: 11.5, color: c.muted, fontWeight: '700' },
    ...
    place: { fontSize: 13.5, fontWeight: '700', color: c.text },
    arrow: { color: c.info, fontSize: 15, fontWeight: '800' },
    meta: { fontSize: 11.5, color: c.muted, marginTop: 5 },
    itemsBox: { marginTop: 10, borderTopWidth: 1, borderTopColor: c.border, paddingTop: 8 },
    itemRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 6 },
    itemName: { flex: 1, fontSize: 12.5, color: c.text, fontWeight: '600' },
    itemQty: { fontSize: 12.5, color: c.accent, fontWeight: '800', marginLeft: 8 },
    itemMax: { fontSize: 11, color: c.muted, marginLeft: 4 },
    ...
    placePickerLabel: { fontSize: 10.5, color: c.muted, fontWeight: '700', textTransform: 'uppercase' },
    placePickerValue: { fontSize: 13, fontWeight: '800', color: c.text, marginTop: 2 },
    ...
    resultMeta: { fontSize: 11, color: c.muted, marginTop: 1 },
    addBtn: { fontSize: 18, color: c.primary, fontWeight: '800', marginLeft: 10 },
