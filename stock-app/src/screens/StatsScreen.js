          ...
          <View style={styles.section}>
            ...
            <BarChart
              ...
              chartConfig={{
                ...
                backgroundGradientTo: colors.card,
                decimalPlaces: 0,
                color: (opacity = 1) => `rgba(34, 160, 107, ${opacity})`, // vert marge
                labelColor: () => colors.muted,
                barPercentage: 0.55,
...
const styles = StyleSheet.create({
  ...
  marginHint: { fontSize: 11, color: colors.muted, marginTop: 10, textAlign: 'center' },
  viewTab: { flex: 1, paddingVertical: 9, borderRadius: 9, alignItems: 'center' },
  viewTabActive: { backgroundColor: colors.primaryBg },
  viewTabText: { fontSize: 13, fontWeight: '700', color: colors.muted },
  ...
  errorBox: { backgroundColor: colors.dangerBg, borderRadius: 10, padding: 12, marginBottom: 14, alignItems: 'center' },
  errorText: { color: colors.danger, fontSize: 13, textAlign: 'center' },
  retry: { color: colors.accent, fontWeight: '700', marginTop: 6 },
  ...
  thumb: { width: 40, height: 40, borderRadius: 10, marginRight: 10, backgroundColor: colors.cardAlt },
  ...
  rowRevenue: { fontSize: 12.5, fontWeight: '800', color: colors.accent, maxWidth: 92, textAlign: 'right' },
  modalBackdrop: { flex: 1, backgroundColor: 'rgba(3,6,18,0.7)' },
  dateLbl: { fontSize: 12, fontWeight: '700', color: colors.muted, marginTop: 12, marginBottom: 6 },
  dateInput: {
    backgroundColor: colors.card,
    borderRadius: 12,
    borderWidth: 1,
  ...
  dateCancelText: { color: colors.muted, fontWeight: '700', fontSize: 13.5 },
  modalCard: {
    position: 'absolute',
    left: 0,
    right: 0,
  ...
  modalTitle: { fontSize: 16.5, fontWeight: '800', color: colors.text },
  ...
  pmTileLabel: { fontSize: 10.5, color: colors.muted, marginTop: 2 },
  pmRevenue: { fontSize: 13, fontWeight: '700', color: colors.text, marginTop: 12 },
  pmMoveRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 9,
  ...
  pmMoveReason: { fontSize: 12.5, fontWeight: '600', color: colors.text },
  pmMoveMeta: { fontSize: 10.5, color: colors.muted, marginTop: 1 },
  ...
  pmCloseText: { color: colors.primary, fontWeight: '800' },
});
