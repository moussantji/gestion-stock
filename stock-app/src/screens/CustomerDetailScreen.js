...
const styles = StyleSheet.create({
  ...
  waText: { color: colors.success, fontWeight: '800', fontSize: 13 },
  meta: { fontSize: 12.5, color: colors.muted, marginTop: 3 },
  errorBox: { marginTop: 12, backgroundColor: colors.dangerBg, borderRadius: 12, padding: 14 },
  errorText: { color: colors.danger, fontSize: 13, textAlign: 'center' },
  grid: { flexDirection: 'row', marginTop: 12 },
  sectionTitle: { fontSize: 14, fontWeight: '800', color: colors.text, marginTop: 20, marginBottom: 8 },
  pointsCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: colors.primaryBg,
  ...
  pointsTitle: { color: colors.text, fontSize: 14, fontWeight: '800' },
  pointsMeta: { color: colors.muted, fontSize: 11.5, marginTop: 3 },
  pointsValue: { color: colors.primary, fontSize: 20, fontWeight: '800' },
  pointsList: {
    backgroundColor: colors.card,
    borderRadius: 12,
    borderWidth: 1,
  ...
  pointsNote: { color: colors.text, fontSize: 12.5, fontWeight: '600' },
  pointsDate: { color: colors.muted, fontSize: 11, marginTop: 2 },
  ...
  hintSmall: { fontSize: 10, color: colors.muted, fontWeight: '700', marginTop: 2 },
  // 💳 v24 (v2.13) — échéancier planifié
  planCard: {
  ...
  planHint: { color: colors.muted, fontSize: 11, lineHeight: 15, marginTop: 4, marginBottom: 10 },
  planChips: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  planNone: { color: colors.muted, fontSize: 12 },
  planChip: {
  ...
  planChipLate: { borderWidth: 1, borderColor: colors.danger },
  planChipText: { color: colors.text, fontSize: 12, fontWeight: '700' },
  planChipX: { color: colors.muted, fontSize: 11, paddingLeft: 2 },
  planAddRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 10 },
  planQuickBtn: { backgroundColor: colors.bg, borderRadius: 8, paddingVertical: 8, paddingHorizontal: 10 },
  planQuickText: { color: colors.accent, fontSize: 12, fontWeight: '800' },
  planInput: {
    flex: 1, backgroundColor: colors.bg, color: colors.text, borderRadius: 8,
    paddingVertical: 8, paddingHorizontal: 10, fontSize: 12,
  },
  planAddBtn: { backgroundColor: colors.primary, borderRadius: 8, paddingVertical: 9, paddingHorizontal: 12 },
