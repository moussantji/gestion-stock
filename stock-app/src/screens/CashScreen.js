...
const styles = StyleSheet.create({
  ...
  balanceLabel: { fontSize: 12, fontWeight: '800', color: colors.muted, textTransform: 'uppercase', letterSpacing: 0.8 },
  balanceValue: { fontSize: 30, fontWeight: '900', marginTop: 6 },
  balanceMeta: { fontSize: 11.5, color: colors.muted, marginTop: 8 },
  ...
  todayLabel: { fontSize: 11, fontWeight: '700', color: colors.muted },
  todayValue: { fontSize: 15, fontWeight: '900', marginTop: 4 },
  salesNote: { fontSize: 11.5, color: colors.muted, marginTop: 10, textAlign: 'center' },
  sectionTitle: { fontSize: 14, fontWeight: '800', color: colors.text, marginTop: 18, marginBottom: 6 },
  ...
  reason: { fontSize: 13.5, fontWeight: '700', color: colors.text },
  ...
  chartTitle: { color: colors.text, fontSize: 13.5, fontWeight: '800', marginBottom: 6 },
  pdfBtn: {
  ...
  pdfBtnText: { color: colors.info, fontSize: 11.5, fontWeight: '800' },
  closeBtn: {
    backgroundColor: colors.infoBg,
    borderRadius: 12,
    borderWidth: 1,
  ...
  closeBtnText: { color: colors.info, fontWeight: '800', fontSize: 13.5 },
  viewToggle: {
    flexDirection: 'row',
    backgroundColor: colors.card,
    borderRadius: 12,
  ...
  viewChipActive: { backgroundColor: colors.primaryBg },
  viewChipText: { fontSize: 12.5, fontWeight: '800', color: colors.muted },
  ...
  catChipText: { fontSize: 11.5, fontWeight: '700', color: colors.muted },
