...
const styles = StyleSheet.create({
  ...
  sheetTitle: { color: colors.text, fontSize: 17, fontWeight: '800', marginBottom: 14 },
  fieldLabel: { color: colors.text, fontSize: 12.5, fontWeight: '700', marginTop: 12, marginBottom: 6 },
  select: {
    backgroundColor: colors.card,
    borderWidth: 1,
    borderColor: colors.border,
  ...
  freqText: { color: colors.muted, fontSize: 13.5, fontWeight: '700' },
  lineRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  lineName: { color: colors.text, fontSize: 13.5, fontWeight: '700' },
  priceInput: {
    color: colors.accent,
    fontSize: 12.5,
    fontWeight: '700',
  ...
  stepText: { color: colors.text, fontSize: 14, fontWeight: '800' },
  stepValue: { color: colors.text, fontWeight: '800', minWidth: 20, textAlign: 'center' },
  addLine: {
    borderRadius: 10,
    borderWidth: 1.5,
    borderStyle: 'dashed',
  ...
  creditNote: { color: colors.muted, fontSize: 11.5, marginTop: 12, lineHeight: 16 },
