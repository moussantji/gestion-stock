...
const styles = StyleSheet.create({
  ...
  segChipText: { fontSize: 11.5, fontWeight: '700', color: colors.muted },
  segHint: { color: colors.muted, fontSize: 11, paddingHorizontal: 18, marginTop: 6 },
  tierLabel: { fontSize: 13, fontWeight: '600', color: colors.text, marginBottom: 6 },
  ...
  tierChipText: { color: colors.muted, fontSize: 13, fontWeight: '700' },
  tierHint: { color: colors.info, fontSize: 11.5, marginTop: -4, marginBottom: 10 },
  notifyBtn: {
  ...
  notifyText: { color: colors.info, fontWeight: '800', fontSize: 12 },
  ...
  credit: { fontSize: 11.5, color: colors.warning, fontWeight: '700', marginTop: 2 },
  spent: { fontSize: 13.5, fontWeight: '900', color: colors.accent, marginLeft: 8 },
  fab: {
    position: 'absolute',
    right: 20,
    bottom: 30,
