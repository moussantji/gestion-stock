...
const styles = StyleSheet.create({
  ...
  number: { fontSize: 12.5, color: colors.accent, fontFamily: 'monospace', marginTop: 3 },
  due: { fontSize: 13, color: colors.warning, fontWeight: '700', marginTop: 8, marginBottom: 14 },
  ...
  allText: { color: colors.accent, fontWeight: '800', fontSize: 13 },
  submit: {
